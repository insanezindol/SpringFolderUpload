...
public class ResponseHelper {
	...
	public static void outputToClient(HttpServletResponse response, String data) {
		outputToClient(response, data, CommonConstant.DEFAULT_ENCODING);
	}
	...
	public static void outputToClientHtml(HttpServletResponse response, String data) {
		outputToClientHtml(response, data, CommonConstant.DEFAULT_ENCODING);
	}
	...
	public static void outputJSONData(HttpServletRequest request, HttpServletResponse response, Object data) {
		outputJSONData(request, response, data, CommonConstant.DEFAULT_ENCODING);
	}
	 ...
	 *            문자셋
	 */
	public static void outputJSONData(HttpServletRequest request, HttpServletResponse response, Object data, String charset) {
	...
	public static void outputJSON(HttpServletRequest request, HttpServletResponse response, Object data) {
		outputJSON(request, response, data, CommonConstant.DEFAULT_ENCODING);
	}
	 ...
	 *            문자셋
	 */
	public static void outputJSON(HttpServletRequest request, HttpServletResponse response, Object data, String charset) {
		response.setContentType("application/json; charset=" + charset);
		...
		resData.setResponseCode(CommonConstant.SUCCESS_CD);
		resData.setResponseText(CommonConstant.SUCCESS_NM);
	 ...
	 *            오류 객체
	 */
	public static void outputJSON(HttpServletRequest request, HttpServletResponse response, String errCode, String errMsg, Throwable t) {
		outputJSON(request, response, errCode, errMsg, t, CommonConstant.DEFAULT_ENCODING);
	}
	 ...
	 *            문자셋
	 */
	public static void outputJSON(HttpServletRequest request, HttpServletResponse response, String errCode, String errMsg, Throwable t, String charset) {
		response.setContentType("application/json; charset=" + charset);
	...
	public static void outputJSONArray(HttpServletResponse response, Object arrayOrList) {
		outputJSONArray(response, JSONArray.fromObject(arrayOrList).toString(), CommonConstant.DEFAULT_ENCODING);
	}
	 ...
	 *            문자셋
	 */
	public static void outputJSONArray(HttpServletResponse response, Object arrayOrList, String charset) {
	...
	public static void outputJSONRaw(HttpServletResponse response, String jsonData) {
		outputJSONRaw(response, jsonData, CommonConstant.DEFAULT_ENCODING);
	}
	 ...
	 *            문자셋
	 */
	public static void outputJSONRaw(HttpServletResponse response, String jsonData, String charset) {
		response.setContentType("application/json; charset=" + charset);
	...
	public static void outputXMLFromString(HttpServletResponse response, String xml) {
		outputXMLFromString(response, xml, CommonConstant.DEFAULT_ENCODING);
	}
