...
public class CommonController extends MultiActionController {
	...
	/**
	 * JSON 문자열을 Object의 Array로 변환 (List 형태의 입력을 받을 경우 List 의 객체 정보를 classMap 으로
	 * 넘겨준다)
	 * 
	 * <pre>
	 * Example:
	...
	/**
	 * JSON 문자열을 Object의 List로 변환 (List 형태의 입력을 받을 경우 List 의 객체 정보를 classMap 으로
	 * 넘겨준다)
	 * 
	 * <pre>
	 * Example:
	...
	public void outputToClientHtml(HttpServletResponse response, String data) {
		ResponseHelper.outputToClientHtml(response, data, CommonConstant.DEFAULT_ENCODING);
	}
	 ...
	 *            오류 객체
	 */
	public void outputJSON(HttpServletRequest request, HttpServletResponse response, String errCode, String errMsg, Throwable t) {
	 ...
	 *            문자셋
	 */
	public void outputJSON(HttpServletRequest request, HttpServletResponse response, String errCode, String errMsg, Throwable t, String charset) {
	 ...
	 *            문자셋
	 */
	public void outputJSONArray(HttpServletResponse response, Object arrayOrList, String charset) {
