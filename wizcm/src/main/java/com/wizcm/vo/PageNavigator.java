...
public class PageNavigator {
	...
	private int startRow; // 쿼리로 조회시 시작 로우 번호
	private int endRow; // 쿼리로 조회시 마지막 로우 번호
	...
	public void makePaging() {
		...
		this.setStartRow(pageNo * pageSize - pageSize + 1); // 시작 행 번호
		this.setEndRow(pageNo * pageSize); // 종료 행 번호
	}
}
